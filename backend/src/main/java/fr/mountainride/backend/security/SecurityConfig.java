...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf(csrf -> csrf.disable()) // Désactivé car utilisation de JWT (stateless)
                ...
                // Insère ce filtre JWT AVANT le filtre standard de Spring Security
    ...
    // Définition de l'algorithme de hashage des mots de passe
    @Bean
